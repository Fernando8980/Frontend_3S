...
def somar():
    if request.method == 'POST':
        if request.form['form-n1'] and request.form['form-n2']:
            ...
            # passo 1 :Repetir a msg e a categoria do Flash
...
def cadastro_funcionario():
    if request.method == 'POST':
        ...
        if existe_cpf:
            ...
            return render_template('cadastro.html')
        try:
            novo_usuario = Funcionario(nome=nome, email=email, cpf=cpf, cargo=cargo, salario=float(salario),
